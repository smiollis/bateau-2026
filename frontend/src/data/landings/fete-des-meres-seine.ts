...
export const feteDesMeresSeine: LandingPageData = {
  ...
  meta: {
    ...
    description:
      "Offrez à votre maman une croisière privée sur la Seine pour la Fête des Mères. Champagne, Tour Eiffel, moment en famille. Dès 360\u00a0€.",
  },
  hero: {
...
<p>La <strong>formule festive</strong> (420\u00a0€) inclut le champagne, idéale pour trinquer en famille. Vous pouvez aussi préparer un brunch flottant ou commander nos planches apéritives. Le concept BYO vous permet d\u2019apporter gâteau, boissons et tout ce que maman aime.</p>
...
<p>Nous proposons des <strong>bons cadeaux</strong> personnalisés à offrir le jour J. Départ du Port de l\u2019Arsenal à Bastille. Réservez le créneau du coucher de soleil pour une lumière magique sur les photos de famille.</p>`,
    ...
    { type: "pricing", title: "Nos formules Fête des Mères" },
    {
      ...
      items: [
        ...
        { question: "Combien de personnes maximum ?", answer: "Le Senang accueille jusqu\u2019à 12 personnes. Tarif de base pour 1 à 6 personnes (360\u00a0€ simple), +100\u00a0€ par personne au-delà." },
      ],
    },
  ],
