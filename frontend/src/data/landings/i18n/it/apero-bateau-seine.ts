...
const translation: LandingPageTranslation = {
  meta: { title: "Aperitivo in barca sulla Senna – Aperitivo privato a Parigi", description: "Organizza un aperitivo sulla Senna a bordo di una barca privata. BYO (porta le tue bevande), 2 ore di crociera, 2 a 12 persone. Da 80€/pers." },
  ...
  sections: [
    ...
    { type: "benefits", title: "Perché un aperitivo sulla Senna?", items: [
      ...
      { icon: "wallet", title: "Da 80€/pers.", text: "480€ per 6 = il miglior rapporto qualità-prezzo di Parigi." },
    ...
    { type: "faq", title: "Domande frequenti – Aperitivo in barca", items: [
      ...
      { question: "Quanto costa a persona?", answer: "480€ per 1 a 6 persone = 80€/pers. per 6 amici. Oltre, +110€ per persona (max 12)." },
