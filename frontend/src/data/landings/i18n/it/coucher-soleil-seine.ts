...
const translation: LandingPageTranslation = {
  meta: { title: "Crociera al tramonto sulla Senna – Golden hour a Parigi", description: "Vivete la golden hour sulla Senna. Crociera privata di 2h al tramonto, Torre Eiffel illuminata, champagne. A partire da 490€." },
  ...
  sections: [
    ...
    { type: "faq", title: "Domande frequenti – Tramonto", items: [
      ...
      { question: "Questa fascia è più cara?", answer: "No, le tariffe sono le stesse: 490€ (semplice) o 540€ (festiva). Ma questa fascia è molto richiesta, prenotate in anticipo." },
