...
const translation: LandingPageTranslation = {
  meta: { title: "Bootsfahrt bei Sonnenuntergang auf der Seine – Golden Hour in Paris", description: "Erlebt die Golden Hour auf der Seine. 2-stündige Privatfahrt bei Sonnenuntergang, beleuchteter Eiffelturm, Champagner. Ab 490€." },
  ...
  sections: [
    ...
    { type: "faq", title: "Häufig gestellte Fragen – Sonnenuntergang", items: [
      ...
      { question: "Ist dieser Slot teurer?", answer: "Nein, die Preise sind identisch: 490€ (Basis) oder 540€ (Fest). Aber dieser Slot ist sehr gefragt, bucht im Voraus." },
