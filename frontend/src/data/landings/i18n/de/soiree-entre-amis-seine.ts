...
const translation: LandingPageTranslation = {
  meta: { title: "Abend mit Freunden auf der Seine – Aperitif-Boot in Paris", description: "Organisiere einen Abend mit Freunden auf der Seine. Privatboot bis 12 Personen, freies Catering, eigene Playlist. 2 Stunden Fahrt ab 480€." },
  ...
  sections: [
    ...
    { type: "benefits", title: "Warum ein Boot für den Freunde-Abend?", items: [
      ...
      { icon: "wallet", title: "Ab 80€/Pers.", text: "480€ für 6 Personen = 80€ pro Person. Unschlagbar in Paris." },
    ] },
    ...
    { type: "faq", title: "Häufig gestellte Fragen – Abend mit Freunden", items: [
      ...
      { question: "Was kostet es pro Person?", answer: "Das Basispaket für 480€ gilt für bis zu 6 Personen, also 80€ pro Person. Darüber hinaus 110€ pro zusätzliche Person (max 12)." },
