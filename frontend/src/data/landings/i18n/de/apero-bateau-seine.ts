...
const translation: LandingPageTranslation = {
  meta: { title: "Aperitif auf dem Boot auf der Seine – Privater Aperitif in Paris", description: "Organisiert einen Aperitif auf der Seine an Bord eines Privatbootes. BYO (bringt eure Getränke mit), 2 Stunden Fahrt, 2 bis 12 Personen. Ab 82€/Pers." },
  ...
  sections: [
    ...
    { type: "benefits", title: "Warum ein Aperitif auf der Seine?", items: [
      ...
      { icon: "wallet", title: "Ab 82€/Pers.", text: "490€ für 6 = das beste Preis-Leistungs-Verhältnis in Paris." },
    ...
    { type: "faq", title: "Häufig gestellte Fragen – Aperitif-Boot", items: [
      ...
      { question: "Was kostet es pro Person?", answer: "490€ für 1 bis 6 Personen = 82€/Pers. für 6 Freunde. Darüber hinaus +110€ pro Person (max 12)." },
