...
const translation: LandingPageTranslation = {
  meta: { title: "Cruzeiro romântico no Sena – Noite privada em Paris", description: "Presenteie com um cruzeiro romântico privado no Sena. 2h a dois com champanhe, pôr do sol e monumentos iluminados. A partir de 540€." },
  ...
  sections: [
    ...
    { type: "faq", title: "Perguntas frequentes – Cruzeiro romântico", items: [
      ...
      { question: "Quanto custa um cruzeiro romântico?", answer: "A partir de 490€ (pacote simples) ou 540€ (pacote festivo com champanhe) para um cruzeiro privado de 2 horas." },
    ] },
  ],
};
