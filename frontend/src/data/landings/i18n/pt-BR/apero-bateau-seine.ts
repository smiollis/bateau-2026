...
const translation: LandingPageTranslation = {
  meta: { title: "Aperitivo no barco no Sena – Happy hour privado em Paris", description: "Organize um aperitivo no Sena a bordo de um barco privado. BYO (traga suas bebidas), 2h de cruzeiro, 2 a 12 pessoas. A partir de 80€/pes." },
  ...
  sections: [
    ...
    { type: "benefits", title: "Por que um aperitivo no Sena?", items: [
      ...
      { icon: "wallet", title: "A partir de 80€/pes.", text: "480€ para 6 = o melhor custo-benefício de Paris." },
    ...
    { type: "faq", title: "Perguntas frequentes – Aperitivo no barco", items: [
      ...
      { question: "Quanto custa por pessoa?", answer: "480€ para 1 a 6 pessoas = 80€/pes. para 6 amigos. Além disso, +110€ por pessoa (máx. 12)." },
