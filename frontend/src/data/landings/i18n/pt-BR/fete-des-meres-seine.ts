...
const translation: LandingPageTranslation = {
  meta: { title: "Dia das Mães no Sena – Cruzeiro presente em Paris", description: "Presenteie sua mãe com um cruzeiro privado no Sena para o Dia das Mães. Champanhe, Torre Eiffel, momento em família. A partir de 360€." },
  ...
  sections: [
    ...
    { type: "faq", title: "Perguntas frequentes – Dia das Mães", items: [
      ...
      { question: "Quantas pessoas no máximo?", answer: "O Senang acomoda até 12 pessoas. Tarifa base para 1 a 6 pessoas (360€ simples), +100€ por pessoa adicional." },
    ] },
  ],
};
