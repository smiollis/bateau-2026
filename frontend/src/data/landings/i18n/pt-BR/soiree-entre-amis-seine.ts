...
const translation: LandingPageTranslation = {
  meta: { title: "Noite entre amigos no Sena – Aperitivo no barco em Paris", description: "Organize uma noite entre amigos no Sena. Barco privativo até 12 pessoas, aperitivo livre, playlist pessoal. 2h de cruzeiro a partir de 490€." },
  ...
  sections: [
    ...
    { type: "benefits", title: "Por que escolher um barco para a noite entre amigos?", items: [
      ...
      { icon: "wallet", title: "A partir de 82€/pes.", text: "490€ para 6 pessoas = 82€ cada. Imbatível em Paris." },
    ] },
    ...
    { type: "faq", title: "Perguntas frequentes – Noite entre amigos", items: [
      ...
      { question: "Quanto custa por pessoa?", answer: "O pacote simples a 490€ cobre até 6 pessoas, ou seja, 82€ por pessoa. Além disso, 110€ por pessoa adicional (máx. 12)." },
