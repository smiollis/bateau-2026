...
const translation: LandingPageTranslation = {
  meta: { title: "Cruzeiro ao pôr do sol no Sena – Golden hour em Paris", description: "Viva a golden hour no Sena. Cruzeiro privado de 2h ao pôr do sol, Torre Eiffel iluminada, champanhe. A partir de 360€." },
  ...
  sections: [
    ...
    { type: "faq", title: "Perguntas frequentes – Pôr do sol", items: [
      ...
      { question: "Esse horário é mais caro?", answer: "Não, os valores são os mesmos: 360€ (simples) ou 420€ (festivo). Mas esse horário é muito procurado, reserve com antecedência." },
