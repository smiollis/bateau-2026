...
const translation: LandingPageTranslation = {
  meta: { title: "Cruzeiro de Natal no Sena – Festas no barco em Paris", description: "Viva a magia do Natal no Sena. Cruzeiro privado, Paris iluminada, clima de conto de fadas. Barco privatizado de 2 a 12 pessoas. A partir de 360€." },
